...
import * as sty from "./PlasmicDescription.module.css"; // plasmic-import: 7ZT2NcqqvK1V8/css
  ...
  return (
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <PlasmicLogoIcon
            className={classNames(defaultcss.all, sty.svg__yQcZg)}
            role={"img"}
          />
        ),
