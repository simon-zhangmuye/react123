...
import * as sty from "./PlasmicListItem.module.css"; // plasmic-import: 94-lZb0fjQQyA/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__e0NLx, {
          [sty.box__noBody__e0NLxur7Mr]: hasVariant(
            variants,
            "noBody",
            "noBody"
          )
      ...
      {(hasVariant(variants, "noBody", "noBody") ? false : true) ? (
        <div
          className={classNames(defaultcss.all, sty.box__pmCts, {
            [sty.box__noBody__pmCtsur7Mr]: hasVariant(
              variants,
              "noBody",
              "noBody"
            )
